...
class Plato_dsl
	...
	#	while(@alimentos!=nil)
	#		num_proteinas += @alimentos.head.value.proteinas * (@gramos.head.value / (@alimentos.head.value.proteinas+@alimentos.head.value.lipidos+@alimentos.head.value.carbohidratos))
	#		@alimentos.next
	#		@gramos.next
	#	end
#
